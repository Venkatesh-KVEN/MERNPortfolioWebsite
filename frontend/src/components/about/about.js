        ...
        <div className="row align-items-center">
          <div className="col-md-6 pe-3 pe-md-5 pe-lg-5 mb-5 mb-md-3 mb-lg-0">
            <div className="h-100 text-white rounded-0">
              ...
              <p data-aos="fade-right" data-aos-easing="ease-in-sine" className='mb-5 text-justify'>{description}</p>
              <p data-aos="fade-right" data-aos-easing="ease-in-sine" className='mb-5 text-justify'>{content}</p>
              <div className='flex'>
              {
                skill?.map((item, index) => (
                  <button key={index} className="btn custom-btn disabled cursor-not-allowed rounded-pill mx-2 about-card-skills mb-3 mb-md-2 mb-lg-2" data-aos="fade-right" data-aos-easing="ease-in-sine">{item.trim()}</button>
                ))
              }
              </div>
            </div>
